...
public class StarsSounds {
    ...
    public static final RegistryObject<SoundEvent> BONG = registerSoundEvent("bong");       //普通格挡
    public static final RegistryObject<SoundEvent> BIGBONG = registerSoundEvent("bigbong"); //完美弹刀
    public static final RegistryObject<SoundEvent> DANGER = registerSoundEvent("danger");   //危
    public static final RegistryObject<SoundEvent> DUANG1 = registerSoundEvent("duang1");   //处决照成伤害
    public static final RegistryObject<SoundEvent> DUANG2 = registerSoundEvent("duang2");   //处决造成伤害
    public static final RegistryObject<SoundEvent> FORESIGHT = registerSoundEvent("foresight"); //完美闪避
    public static final RegistryObject<SoundEvent> YAMATO_STEP = registerSoundEvent("yamato_step");
    public static final RegistryObject<SoundEvent> SEKIRO = registerSoundEvent("sekiro");   //开始处决音效
    public static final RegistryObject<SoundEvent> CHUA = registerSoundEvent("chua");   //高冲反斩

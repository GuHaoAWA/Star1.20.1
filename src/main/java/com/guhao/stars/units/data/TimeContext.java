package com.guhao.stars.units.data;
...
public class TimeContext { 
    ...
    public static class Client {
        ...
        public static long generateUniqueSeed() {
            return (StarDataUnit.isTimeStopped()) ? (SEED_UNIQUIFIER.get() * 1181783497276652981L) ^ (Both.timeStopModifyMillis * 1000000L) : SEED_UNIQUIFIER.updateAndGet((p_224601_) -> {
                return p_224601_ * 1181783497276652981L;
            }) ^ (Both.timeStopModifyMillis * 1000000L);
        }

        public static float alwaysPartial() {
            return (StarDataUnit.isTimeStopped() || Minecraft.getInstance().pause) ? Client.timer.partialTick : Minecraft.getInstance().getPartialTick();
        }
